...
void initGame(aviao * aviao, tiro * tiro1, tiro * tiro2, tiro * tiro3, meteoro * bloco, meteoro * lanterna, meteoro * quadriculado, meteoro * triangulo, meteoro * circulo, pontuacao * pontuacao, statusTela * statusTela, musicaTocar * musicaTocar)
{
